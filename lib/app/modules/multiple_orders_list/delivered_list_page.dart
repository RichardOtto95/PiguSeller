...
class DeliveredListPage extends StatefulWidget {
  final String title;
  final group;
  const DeliveredListPage(
      {Key key, this.title = "DeliveredListPage", this.group})
      : super(key: key);

  @override
  _DeliveredListPageState createState() => _DeliveredListPageState();
}

class _DeliveredListPageState
    extends ModularState<DeliveredListPage, MultipleOrdersListController> {
  bool click = false;
  bool showMenu = false;
  final homeController = Modular.get<HomeController>();
  final controller = Modular.get<MultipleOrdersListController>();
  String clickLabel;
  // Future<dynamic> _deliveredAskings;
  bool eventVerifier;
  // List<dynamic> deliveredAskings = new List();
  ...
  void initState() {
    ...
    // setState(() {
    //   _deliveredAskings = getDelivered();
    // });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    // _deliveredAskings.then((value) {
    //   print(
    //       'deliveredAskingsdeliveredAskingsdeliveredAskingsdeliveredAskingsdeliveredAskings   :::$value');
    // });
    return WillPopScope(
      onWillPop: () {
                              ...
                              builder: (context, snapshot) {
                                if (snapshot.connectionState ==
                                  ...
                                  return EmptyStateList(
                                    ...
                                    title: 'Sem pedidos em entregues',
                                    description:
                                        'Não existem pedidos entregues para serem listados',
                                  );
                                } else {

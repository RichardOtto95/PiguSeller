...
class RefusedListPage extends StatefulWidget {
  final String title;
  final group;
  const RefusedListPage({Key key, this.title = "RefusedListPage", this.group})
      : super(key: key);

  @override
  _RefusedListPageState createState() => _RefusedListPageState();
}

class _RefusedListPageState
    extends ModularState<RefusedListPage, MultipleOrdersListController> {
  bool click = false;
  bool showMenu = false;
  final homeController = Modular.get<HomeController>();
  final controller = Modular.get<MultipleOrdersListController>();
  String clickLabel;
  // Future<dynamic> _refusedAskings;
  bool eventVerifier;
  // List<dynamic> refusedAskings = new List();
  ...
  Widget build(BuildContext context) {
    ...
    // _refusedAskings.then((value) {
    //   print(
    //       'refusedAskingsrefusedAskingsrefusedAskingsrefusedAskingsrefusedAskings   :::$value');
    // });
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState == ConnectionState.waiting)
                          ...
                          return EmptyStateList(
                            ...
                            title: 'Sem pedidos recusados',
                            description:
                                'Não existem pedidos recusados para serem listados',
                          );
                        } else {
